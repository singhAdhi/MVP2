...
const UnlockGaming = (props) => {
  ...
  if (isLoading) {
    return <Loading loadingText="Unlock Gaming Adventures" />;
  }

  if (isError) {
    return <Error errorText="Unlock Gaming Adventures not found" />;
  }

  return (
    <>
      <Heading headingText="Unlock Gaming Adventures" />
      <SwiperSlider
        options={options}
