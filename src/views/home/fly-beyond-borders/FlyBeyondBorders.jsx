...
const FlyBeyondBorders = (props) => {
  ...
  if (isLoading) {
    return <Loading loadingText="Fly Beyond Borders" />;
  }

  if (isError) {
    return <Error errorText="Fly Beyond Borders not found" />;
  }

  return (
    <>
      <Heading headingText="Fly Beyond Borders" />
      <SwiperSlider
        options={options}
...
export default FlyBeyondBorders;
