...
import "./experiencelivesports.css";
...
const ExperienceLiveSports = (props) => {
  const options = {
  ...
  if (isLoading) {
    return <Loading loadingText="Experience the live sports" />;
  }

  if (isError) {
    return <Error errorText="Experience the live sports not found" />;
  }

  return (
    <>
      <Heading headingText="Experience the live sports" />
      <SwiperSlider
...
export default ExperienceLiveSports;
